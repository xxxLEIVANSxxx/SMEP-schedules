...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { arena_id: @hour.arena_id, cost: @hour.cost, time: @hour.time } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { arena_id: @hour.arena_id, cost: @hour.cost, time: @hour.time } }
