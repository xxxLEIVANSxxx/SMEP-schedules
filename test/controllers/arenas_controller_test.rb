...
class ArenasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arena" do
    assert_difference('Arena.count') do
      post arenas_url, params: { arena: { address_id: @arena.address_id, name: @arena.name } }
    end
  ...
  test "should update arena" do
    patch arena_url(@arena), params: { arena: { address_id: @arena.address_id, name: @arena.name } }
