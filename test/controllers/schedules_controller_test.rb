...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { hour_id: @schedule.hour_id, user_id: @schedule.user_id } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { hour_id: @schedule.hour_id, user_id: @schedule.user_id } }
